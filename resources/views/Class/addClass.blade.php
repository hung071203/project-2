...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home /</span><span class="text-muted fw-light">Class /</span> Add new Class</h4>
{{--        @dd($courses)--}}
        <!-- Basic Bootstrap Table -->
        <div class="card">
            <h5 class="card-header">Add new Class</h5>
            <div class="card-body">
                <form id="formAuthentication" class="mb-3" action="{{route('addclass.store')}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="defaultFormControlInput" name="class_Name" placeholder="Please input..." aria-describedby="defaultFormControlHelp">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="studentSelect" name="m_ID" aria-describedby="defaultFormControlHelp">
                                    @foreach($mjs as $mj)
                                        <option value="{{ $mj->id}}" >{{ $mj->m_Name }}</option>
                                    @endforeach
                                </select>
                                <div id="defaultFormControlHelp" class="form-text"></div>
                            </div>
